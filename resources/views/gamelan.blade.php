        ...
        <div class="instruments-grid">
            ...
            <div class="instrument-card">
                ...
                <div class="instrument-details">
                    <h3>Saron</h3>
                    <p class="instrument-description">Saron merupaakan salah satu instrumen utama dalam ensambel gamelan, terdiri dari bilah-bilah logam yang diletakkan di atas resonator kayu.</p>
            ...
            <div class="instrument-card">
                ...
                <div class="instrument-details">
                    <h3>Gender</h3>
                    <p class="instrument-description">Gender merupaakan salah satu instrumen gamelan yang terdiri dari bilah logam yang disusun di atas resonator kayu dan dimainkan dengan pemukul kecil berlapis kain. Suara yang dihasilkan sangat lembut, melodius, dan memiliki resonansi yang khas, sering kali digunakan untuk memperkaya melodi atau sebagai pengisi antar bagian dalam komposisi gamelan.</p>
            ...
            <div class="instrument-card">
                ...
                <div class="instrument-details">
                    ...
                    <p class="instrument-price">Muulai dari 3,75-21,5jt</p>
                    <a href="#" class="instrument-button">Lihat Lebih Lanjut</a>
                </div>
            </div>
        </div>

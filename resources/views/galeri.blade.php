    ...
    <div class="videos-container">
        ...
        <div class="video-card">
            <div class="video-thumbnail">
                ...
                <video class="video-img" alt="Traditional Javanese Gamelan Concert" controls preload="metadata">
                <source src="{{ asset('video1.mp4') }}" type="video/mp4">
                Browser kamu tidak mendukung video.
                 </video>
            </div>
                <div class="video-info">
                    <h4 class="video-title">Tradisional Gamelan Jawa</h4>
                    <p class="video-description">Gamelan Set, Juni 2017</p>
                </div>
        </div>
        ...
        <div class="video-card">
            <div class="video-thumbnail">
                ...
                <video class="video-img" alt="Instrument Crafting Workshop" controls preload="metadata">
        ...
        <div class="video-card">
            <div class="video-thumbnail">
                ...
                <video class="video-img" alt="Contemporary Fusion Performance" controls preload="metadata">
